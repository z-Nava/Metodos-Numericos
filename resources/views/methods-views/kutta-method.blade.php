...
<body class="bg-gray-100 text-gray-900">
    <div class="container mx-auto p-4">
        <h1 class="text-2xl font-bold mb-4">Método de Range Kutta</h1>
        ...
        <div class="bg-white shadow-md rounded-lg p-6 mb-6">
            ...
            <form action="{{ route('calculate-kutta') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <small class="text-gray-500">Ejemplo: x + y o x * y - y^2 + x^2</small>
                    </div>
            ...
            @if(isset($result))
                <div class="bg-white shadow-md rounded-lg p-6">
                    <h2 class="text-xl font-semibold mb-4">Resultados del Método de Range Kutta</h2>
